...
public class PlayerCarryController : MonoBehaviour
{
    ...
    public string carryTypeParam = "CarryType";  // опц. int: 0/1/2
    ...
    public bool Attach(GameObject prop)
    {
        ...
        // <<< ключевая строка: берём коэффициент для ИГРОКА
        currentMoveMul = CurrentGrip ? CurrentGrip.playerSpeedMul : baseMoveSpeedMul;
        return true;
    }
